    ...
    angular
        ...
        .controller('addElementMenuCtrl',
            ...
            function ($timeout,
                ...
                thisCtrl.CHILD_MENU_ELEMENT_41 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_41');
                thisCtrl.CHILD_MENU_ELEMENT_42 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_42');
                thisCtrl.CHILD_MENU_ELEMENT_43 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_43');
                thisCtrl.CHILD_MENU_ELEMENT_44 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_44');
                thisCtrl.CHILD_MENU_ELEMENT_45 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_45');
                thisCtrl.CHILD_MENU_ELEMENT_46 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_46');
                thisCtrl.CHILD_MENU_ELEMENT_47 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_47');
                thisCtrl.CHILD_MENU_ELEMENT_48 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_48');
                thisCtrl.CHILD_MENU_ELEMENT_49 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_49');
                thisCtrl.CHILD_MENU_ELEMENT_50 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_50');
                thisCtrl.CHILD_MENU_ELEMENT_51 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_51');
                thisCtrl.CHILD_MENU_ELEMENT_52 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_52');
                thisCtrl.CHILD_MENU_ELEMENT_53 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_53');
                thisCtrl.CHILD_MENU_ELEMENT_54 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_54');
                thisCtrl.CHILD_MENU_ELEMENT_55 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_55');
                thisCtrl.CHILD_MENU_ELEMENT_56 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_56');
                thisCtrl.CHILD_MENU_ELEMENT_57 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_57');
                thisCtrl.CHILD_MENU_ELEMENT_58 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_58');
                thisCtrl.CHILD_MENU_ELEMENT_59 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_59');
                thisCtrl.CHILD_MENU_ELEMENT_60 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_60');
                thisCtrl.CHILD_MENU_ELEMENT_61 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_61');
                thisCtrl.CHILD_MENU_ELEMENT_62 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_62');
                thisCtrl.CHILD_MENU_ELEMENT_63 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_63');
                thisCtrl.CHILD_MENU_ELEMENT_64 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_64');
                thisCtrl.CHILD_MENU_ELEMENT_65 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_65');
                thisCtrl.CHILD_MENU_ELEMENT_66 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_66');
                thisCtrl.CHILD_MENU_ELEMENT_67 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_67');
                thisCtrl.CHILD_MENU_ELEMENT_68 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_68');
                thisCtrl.CHILD_MENU_ELEMENT_69 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_69');
                thisCtrl.CHILD_MENU_ELEMENT_70 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_70');
                thisCtrl.CHILD_MENU_ELEMENT_71 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_71');
                thisCtrl.CHILD_MENU_ELEMENT_72 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_72');
                thisCtrl.CHILD_MENU_ELEMENT_73 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_73');
                thisCtrl.CHILD_MENU_ELEMENT_74 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_74');
                thisCtrl.CHILD_MENU_ELEMENT_75 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_75');
                thisCtrl.CHILD_MENU_ELEMENT_76 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_76');
                thisCtrl.CHILD_MENU_ELEMENT_77 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_77');
                thisCtrl.CHILD_MENU_ELEMENT_78 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_78');
                thisCtrl.CHILD_MENU_ELEMENT_79 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_79');
                thisCtrl.CHILD_MENU_ELEMENT_80 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_80');
                thisCtrl.CHILD_MENU_ELEMENT_81 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_81');
                thisCtrl.CHILD_MENU_ELEMENT_82 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_82');
                thisCtrl.CHILD_MENU_ELEMENT_83 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_83');
                thisCtrl.CHILD_MENU_ELEMENT_84 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_84');
                thisCtrl.CHILD_MENU_ELEMENT_85 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_85');
                thisCtrl.CHILD_MENU_ELEMENT_86 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_86');
                thisCtrl.CHILD_MENU_ELEMENT_87 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_87');
                thisCtrl.CHILD_MENU_ELEMENT_88 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_88');
                thisCtrl.CHILD_MENU_ELEMENT_89 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_89');
                thisCtrl.CHILD_MENU_ELEMENT_90 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_90');
                thisCtrl.CHILD_MENU_ELEMENT_91 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_91');
                thisCtrl.CHILD_MENU_ELEMENT_92 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_92');
                thisCtrl.CHILD_MENU_ELEMENT_93 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_93');
                thisCtrl.CHILD_MENU_ELEMENT_94 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_94');
                thisCtrl.CHILD_MENU_ELEMENT_95 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_95');
                thisCtrl.CHILD_MENU_ELEMENT_96 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_96');
                thisCtrl.CHILD_MENU_ELEMENT_97 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_97');
                thisCtrl.CHILD_MENU_ELEMENT_98 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_98');
                thisCtrl.CHILD_MENU_ELEMENT_99 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_99');
                thisCtrl.CHILD_MENU_ELEMENT_100 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_100');
                thisCtrl.CHILD_MENU_ELEMENT_101 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_101');
                thisCtrl.CHILD_MENU_ELEMENT_102 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_102');
                thisCtrl.CHILD_MENU_ELEMENT_103 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_103');
                thisCtrl.CHILD_MENU_ELEMENT_104 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_104');
                thisCtrl.CHILD_MENU_ELEMENT_105 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_105');
                thisCtrl.CHILD_MENU_ELEMENT_106 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_106');
                thisCtrl.CHILD_MENU_ELEMENT_107 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_107');
                thisCtrl.CHILD_MENU_ELEMENT_108 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_108');
                thisCtrl.CHILD_MENU_ELEMENT_109 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_109');
                thisCtrl.CHILD_MENU_ELEMENT_110 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_110');
                thisCtrl.CHILD_MENU_ELEMENT_111 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_111');
                thisCtrl.CHILD_MENU_ELEMENT_112 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_112');
                thisCtrl.CHILD_MENU_ELEMENT_113 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_113');
                thisCtrl.CHILD_MENU_ELEMENT_114 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_114');
                thisCtrl.CHILD_MENU_ELEMENT_115 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_115');
                thisCtrl.CHILD_MENU_ELEMENT_116 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_116');
                thisCtrl.CHILD_MENU_ELEMENT_117 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_117');
                thisCtrl.CHILD_MENU_ELEMENT_118 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_118');
                thisCtrl.CHILD_MENU_ELEMENT_119 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_119');
                thisCtrl.CHILD_MENU_ELEMENT_120 = $filter('translate')('add_elements_menu.CHILD_MENU_ELEMENT_120');
